...
> **Version 0.11.0** — Major expansion with Native Function Calling, rebuilt Consilium Multi-Agent debate system, new LLM profiles, specialized agent personas, and powerful new tools (Git, API, Database). See [CHANGELOG.md](CHANGELOG.md) for details.
